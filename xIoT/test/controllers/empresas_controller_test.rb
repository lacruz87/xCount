...
class EmpresasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post empresas_url, params: { empresa: { nombre_empresa: @empresa.nombre_empresa, rut_empresa: @empresa.rut_empresa, url_app: @empresa.url_app } }
    end
  ...
  test "should update empresa" do
    patch empresa_url(@empresa), params: { empresa: { nombre_empresa: @empresa.nombre_empresa, rut_empresa: @empresa.rut_empresa, url_app: @empresa.url_app } }
